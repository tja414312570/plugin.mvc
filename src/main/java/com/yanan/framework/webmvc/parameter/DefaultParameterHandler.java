...
import com.yanan.framework.webmvc.parameter.annotations.CookieValue;
...
import com.yanan.framework.webmvc.parameter.annotations.RequestHeader;
import com.yanan.framework.webmvc.parameter.annotations.RequestParam;
import com.yanan.framework.webmvc.parameter.annotations.SessionAttributes;
...
public class DefaultParameterHandler implements ParameterHandler {
	...
	public Object getParameter(Parameter paras, Annotation parameterAnnotation) {
		try {
			...
			if (isBaseType(paras.getType())) {
				...
				else if (annoType.equals(com.yanan.framework.webmvc.parameter.annotations.Date.class))
					return this.date((com.yanan.framework.webmvc.parameter.annotations.Date) parameterAnnotation, paras);
				else if (annoType.equals(com.yanan.framework.plugin.annotations.Service.class))
					return this.service((com.yanan.framework.plugin.annotations.Service) parameterAnnotation, paras);
				else
					return null;// 不支持的的类型
	...
	private Object service(com.yanan.framework.plugin.annotations.Service parameterAnnotation, Parameter paras) {
		return PlugsFactory.getPluginsInstance(paras.getType());
	}

	/**
	 * parameter 部分
	 */
	private Object date(com.yanan.framework.webmvc.parameter.annotations.Date parameterAnnotation, Parameter paras)
	...
	private Object date(com.yanan.framework.webmvc.parameter.annotations.Date parameterAnnotation, Field paras)
		...
		try {
			...
			if (isBaseType(field.getType())) {
				if (annoType.equals(CookieValue.class))
					...
					return this.date((com.yanan.framework.webmvc.parameter.annotations.Date) parameterAnnotation, field);
				else
					return null;// 不支持的的类型
			} else {
