...
import com.yanan.framework.webmvc.parameter.ParameterAnnotationType;
import com.yanan.framework.webmvc.response.MethodAnnotationType;
...
public class ServletBean {
	...
	public void setServletClass(Class<?> className) {
		...
		List<MethodAnnotationType> phs = PlugsFactory.getPluginsInstanceList(MethodAnnotationType.class);
	...
	public void addParameter(Parameter parameter) {
		...
		List<ParameterAnnotationType> phs = PlugsFactory.getPluginsInstanceList(ParameterAnnotationType.class);
		List<Class<Annotation>> annos = new ArrayList<Class<Annotation>>();
