...
import com.yanan.utils.beans.XMLBean;
...
public class TokenManager{
	 ...
	 * token 数据持久层接口
	 */
	private TokenHibernateInterface hibernateInterface = PlugsFactory.getPluginsInstanceAllowNull(TokenHibernateInterface.class);
	...
	private void index() {
		...
		Config conf = Environment.getEnviroment().getConfig("Token");
		if(conf!=null){
			conf.allowKeyNull();
