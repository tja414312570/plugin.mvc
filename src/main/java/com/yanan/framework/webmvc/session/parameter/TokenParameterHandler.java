 ...
 *
 */
@Register(attribute={"com.yanan.framework.webmvc.session.parameter.TokenAttribute","com.yanan.framework.webmvc.session.Token"},signlTon=false,priority=-20180519)
