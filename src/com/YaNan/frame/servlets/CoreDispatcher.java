...
public class CoreDispatcher extends HttpServlet{
    ...
    public void init() throws ServletException {
		try {
			if(PlugsFactory.getRegisterDescrption(ServletContextInit.class) == null) {
				ServletContextInit servletContext = PlugsFactory.getPlugsInstance(ServletContextInit.class);
				servletContext.contextInitialized(null);
			}
		} catch (Exception e) {
			e.printStackTrace();
			logger.error("failed to init servlets context!",e);
		}
